    ...
    return Padding(
      ...
      child: ListView(
        ...
        children: [
          ...
          buildAccountCard(
              title: "Full name:    ${authController.user.value?.fullName}",
              onClick: () {}),
          buildAccountCard(
              title: "Email:    ${authController.user.value?.email}",
              onClick: () {}),
          buildAccountCard(
              title:
                  "Age:    ${calculateAge(authController.user.value?.birthDay ?? DateTime.now())}",
              onClick: () {}),
          buildAccountCard(
              title:
