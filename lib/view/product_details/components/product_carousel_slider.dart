...
class _ProductCarouselSliderState extends State<ProductCarouselSlider> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        // Stack to overlay CarouselSlider and back button
        Stack(
          children: [
            // CarouselSlider to display product images
            CarouselSlider(
              items: widget.images
                  .map((e) => Container(
                        color: Colors.white,
                        child: Hero(
                          ...
                          child: CachedNetworkImage(
                            ...
                            imageBuilder: (context, imageProvider) => Container(
                              decoration:
                                  BoxDecoration(color: Colors.white, image: DecorationImage(image: imageProvider)),
                            ),
            ...
            // Positioned Back button on top left
            Positioned(
              child: IconButton(
                onPressed: () {
        ...
        // Row to display indicators for each image
        Row(
